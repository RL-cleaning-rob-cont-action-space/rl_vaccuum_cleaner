...
from bot_cleaner_static_obstacles.algos.sac import SAC  # Import the modified SAC implementation
...
def train() -> None:
    ...
    try:
        ...
        torch.save(agent.policy.state_dict(), "bot_cleaner_static_obstacles/models/sac/sac_final_model.pth")
        env.close()

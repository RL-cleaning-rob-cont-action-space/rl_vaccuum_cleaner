...
from bot_cleaner_static_obstacles.algos.sac import SAC  # Make sure this imports your modified SAC implementation
...
if __name__ == "__main__":
    evaluate(
        model_path="bot_cleaner_static_obstacles/models/sac/sac_final_model.pth",  # Change to your model path
        episodes=3,
        render=True
    )
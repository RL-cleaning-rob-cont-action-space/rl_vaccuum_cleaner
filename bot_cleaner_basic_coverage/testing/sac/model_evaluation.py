...
from bot_cleaner_basic_coverage.algos.sac import SAC
...
def evaluate():
    ...
    agent.actor.load_state_dict(torch.load("bot_cleaner_basic_coverage/models/sac/sac_cleaner_actor.pth"))  # Changed from policy to actor
